# need to parse the raw HTML data to make it easier to read. import Beautiful Soup
...
# create a BeautifulSoup instance that passes in two parameters
...
# step 8: iterate through the data with a for loop. this returns list-like data
...
link_content = requests.get(
    "https://en.wikipedia.org/wiki/Environmental_racism" + python_link
)
